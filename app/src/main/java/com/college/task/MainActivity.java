...
public class MainActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                board_name.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        intent.putExtra("Task_name", board_name);
    ...
    private void update(final String type, final String board_name_text) {
        ...
        DatabaseReference boardtyperef = boardref.child("TASK TYPE");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (board_name_text.isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "TASK name should at least 3 letters", Toast.LENGTH_SHORT).show();
                } else if (checkname(board_name_text)) {
                    Toast.makeText(MainActivity.this, "TASK name is already exist", Toast.LENGTH_SHORT).show();
                } else {
                    builder.dismiss();
